...
if __name__ == '__main__':
    ...
    threading.Thread(target=transferMoneyParallel, args=(user1, user2, 300, add, remove)).start()
    threading.Thread(target=transferMoneyParallel, args=(user2, user3, 100, add, remove)).start()
    threading.Thread(target= transferMoneyParallel, args=(user3, user1, 100, add, remove)).start()
